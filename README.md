...
| :-------- | :---- | :----------- | :--- | :--------- | :------- |
| **Preprints** |
| GeoBrowse | [GeoBrowse: A Geolocation Benchmark for Agentic Tool Use with Expert-Annotated Reasoning Traces](https://arxiv.org/abs/2604.04017v1) | Arxiv 2026 | `FG`, `Rea` | Geolocation benchmark, agentic tool use, expert reasoning traces | [GitHub](https://github.com/ornamentt/GeoBrowse) |
| CountQA | [CountQA: How Well Do MLLMs Count in the Wild?](https://arxiv.org/abs/2508.06585) | Arxiv 2025 | `Cnt` | Visual counting with reasoning | [HuggingFace](https://huggingface.co/datasets/Jayant-Sravan/CountQA) |
...
| Rexverse | [ChatRex: Taming Multimodal LLM for Joint Perception and Understanding](https://arxiv.org/abs/2411.18363) | Arxiv 2024 | `FG` | Fine-grained visual understanding | [GitHub](https://github.com/IDEA-Research/ChatRex) |
| **2026** |
| VisuRiddles | [VisuRiddles: Fine-grained Perception is a Primary Bottleneck for Multimodal Large Language Models in Abstract Visual Reasoning](https://arxiv.org/abs/2506.02537) | AAAI 2026 | `FG` | Visual riddles, fine-grained perception evaluation | [Github](https://github.com/yh-hust/VisuRiddles) |
| GroundingME | [GroundingME: Grounding Multi-Modal Evaluation](https://arxiv.org/abs/2512.17495) | CVPR 2026 | `Grd` | Multi-modal grounding evaluation | [GitHub](https://github.com/lirang04/GroundingME) |
...
| Thyme-SFT/RL | [Thyme: Thinking with Images for Visual Reasoning](https://arxiv.org/abs/2508.11630) | ICLR 2026 | `FG`, `Rea` | Visual reasoning with tool use | [GitHub](https://github.com/yfzhang114/Thyme) |
| Visual Probe | [Mini-o3: Scaling Up Reasoning Patterns and Interaction Turns for Visual Search](https://arxiv.org/abs/2509.07969) | ICLR 2026 | `FG` | Visual probing for perception | [GitHub](https://github.com/Mini-o3/Mini-o3) |
...
| **2025** |
| HR-Bench | [Divide and Conquer: A Comprehensive Benchmark for High-Resolution Image Understanding](https://arxiv.org/abs/2408.15556) | AAAI 2025 | `FG` | High-resolution image understanding | [GitHub](https://github.com/DreamMr/HR-Bench) |
| MME-RealWorld | [MME-RealWorld: Evaluating Real-World Perception in MLLMs](https://arxiv.org/abs/2408.13257) | ICLR 2025 | `FG`, `Grd` | Real-world perception benchmark | [GitHub](https://github.com/MME-Benchmarks/MME-RealWorld) |
| ColorBench | [ColorBench: Can VLMs See and Understand the Colorful World? A Benchmark for Color Perception](https://arxiv.org/abs/2504.10514) | NeurIPS 2025 | `FG` | Color perception evaluation | [GitHub](https://github.com/tianyi-lab/ColorBench) |
| **2024** |
...
| MMVP | [Eyes Wide Shut? Exploring the Visual Shortcomings of Multimodal LLMs](https://arxiv.org/abs/2401.06209) | CVPR 2024 | `FG` | Visual shortcomings evaluation | [GitHub](https://github.com/tsb0601/MMVP) |
| **2017** |
| Visual Genome | [Visual Genome: Connecting Language and Vision Using Crowdsourced Dense Image Annotations](https://arxiv.org/abs/1602.07332) | IJCV 2017 | `Grd`, `FG` | Dense image annotations, grounding | [HuggingFace](https://huggingface.co/datasets/ranjaykrishna/visual_genome) |
...
| --- | --- | --- | --- |
| **2025** |
| [MMEvol: Empowering Multimodal Large Language Models with Evol-Instruct](https://arxiv.org/abs/2409.05840) | ACL 2025 | Evolution, Instruction Tuning | [GitHub](https://github.com/RainBowLuoCS/MMEvol) |
| [Oasis: One Image is All You Need for Multimodal Instruction Data Synthesis](https://arxiv.org/abs/2503.08741) | ICCV 2025 | Autonomous Synthesis, Open-source | [GitHub](https://github.com/Letian2003/MM_INF) |
...
| [Hallucination at a Glance: Controlled Visual Edits and Fine-Grained Multimodal Learning](https://arxiv.org/abs/2506.07227) | NeurIPS 2025 | Minimally Edited, Difference Detection | [GitHub](https://github.com/Relaxed-System-Lab/hallu_med) |
| **2024** |
...
| [Multimodal Self-Instruct: Synthetic Abstract Image and Visual Reasoning Instruction Using Language Model](https://arxiv.org/abs/2407.07053) | EMNLP 2024 | Self-Instruct, Synthetic Data | [GitHub](https://github.com/zwq2018/Multi-modal-Self-instruct) |
...
| --- | --- | --- | --- |
| **Preprints** |
| [Q-Zoom: Query-Aware Adaptive Perception for Efficient Multimodal Large Language Models](https://arxiv.org/abs/2604.06912v1) | Arxiv 2026 | Query-Aware, Adaptive Perception, Efficient Zoom | [Github](https://github.com/YuHengsss/Q-Zoom) |
| [See It, Say It, Sorted: An Iterative Training-Free Framework for Visually-Grounded Multimodal Reasoning in LVLMs](https://arxiv.org/abs/2602.21497v2) | Arxiv 2026 | Training-Free, Iterative, Visually-Grounded Reasoning | [GitHub](https://github.com/uuuuZYC/See-It-Say-It-Sorted) |
| [SvfEye: A Semantic-Visual Fusion Framework with Multi-Scale Visual Context for Multimodal Reasoning](https://arxiv.org/abs/2603.00171v2) | Arxiv 2026 | Semantic-Visual Fusion, Multi-Scale Context | [GitHub](https://github.com/Xiaoxiang100/SvfEye) |
| [Adaptive Chain-of-Focus Reasoning via Dynamic Visual Search and Zooming for Efficient VLMs](https://arxiv.org/abs/2505.15436) | Arxiv 2025 | Focusing Strategy, Chain Reasoning | [GitHub](https://github.com/xtong-zhang/Chain-of-Focus) |
| [Socratic Questioning: Learn to Self-guide Multimodal Reasoning in the Wild](https://arxiv.org/abs/2501.02964) | Arxiv 2025 | Self-guided Reasoning, Socratic Method | [GitHub](https://github.com/aibee00/SocraticQuestioning) |
...
| **2026** |
| [ERGO: Efficient High-Resolution Visual Understanding for Vision-Language Models](https://arxiv.org/abs/2509.21991v2) | ICLR 2026 | Efficient High-Resolution, Visual Understanding | [GitHub](https://github.com/nota-github/ERGO) |
| [Hide: Rethinking the zoom-in method in high resolution mllms via hierarchical decoupling](https://arxiv.org/abs/2510.00054) | ICML 2026 | Attention-based Detection | [GitHub](https://github.com/Tennine2077/HiDe) |
| **2025** |
| [ZoomEye: Enhancing Multimodal LLMs with Human-Like Zooming Capabilities through Tree-Based Search](https://arxiv.org/abs/2411.16044) | EMNLP 2025 | Tree Search, Attention Mapping | [GitHub](https://github.com/om-ai-lab/ZoomEye) |
| [Imagine while Reasoning in Space: Multimodal Visualization-of-Thought](https://arxiv.org/abs/2501.07542) | ICML 2025 | Spatial Visualization, Imaginative Reasoning | [GitHub](https://github.com/chengzu-li/MVoT) |
| **2024** |
...
| [TextCoT: Zoom In for Enhanced Multimodal Text-Rich Image Understanding](https://arxiv.org/abs/2404.09797) | ACM TOMM | Text-rich Images, Zoom-in Strategy | [GitHub](https://github.com/bzluan/TextCoT) |
...
| [Mind's Eye of LLMs: Visualization-of-Thought Elicits Spatial Reasoning in Large Language Models](https://arxiv.org/abs/2404.03622) | NeurIPS 2024 | Visualization-of-Thought, Spatial Reasoning | [GitHub](https://github.com/microsoft/visualization-of-thought/) |
...
| [R1-Omni: Explainable Omni-Multimodal Emotion Recognition with Reinforcement Learning](https://arxiv.org/abs/2503.05379) | Arxiv 2025 | Emotion Recognition, Explainable RL | [GitHub](https://github.com/HumanMLLM/R1-Omni) |
...
| [MedVLM-R1: Incentivizing Medical Reasoning Capability of VLMs via Reinforcement Learning](https://arxiv.org/abs/2502.19634) | Arxiv 2025 | Medical | Medical Reasoning, RL | [GitHub](https://github.com/JZPeterPan/MedVLM-R1) |
...
| [MedCoT: Medical Chain of Thought via Hierarchical Expert](https://arxiv.org/abs/2412.13736) | EMNLP 2024 | Medical | Hierarchical Expert, Medical CoT | [GitHub](https://github.com/JXLiu-AI/MedCoT) |
